...
class ProteinCalculator extends Component
{
    ...
    /**
     * Factual USDA Nutrition Database (Gram Protein per 100g)
     * Moved from Vanilla JS frontend directly into pure PHP array.
     */
    public array $foodDatabase = [
    ...
    public function mount()
    {
        ...
        // Populate target from logged-in user profile if available
    ...
    /**
     * Real-time Calculated Protein based on food source and weight input.
     * Replaces old calculator.js updatePreview() function!
     */
    #[Computed]
    public function calculatedProtein(): float
    {
        if (empty($this->sumber_makanan) || !isset($this->foodDatabase[$this->sumber_makanan]) || $this->berat <= 0) {
            return 0.0;
        }

        $proteinPer100g = $this->foodDatabase[$this->sumber_makanan];
