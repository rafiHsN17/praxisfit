        ...
        foreach ($exercises as $ex) {
            ...
            if (!empty($ex['gifUrl']) && (str_starts_with($ex['gifUrl'], 'http://') || str_starts_with($ex['gifUrl'], 'https://'))) {
                ...
                if (str_starts_with($imgPath, 'http://') || str_starts_with($imgPath, 'https://')) {
                    $icon = $imgPath;
                } elseif (str_contains($imgPath, '/')) {
                    $icon = "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/" . $imgPath;
                } elseif (!empty($ex['id'])) {
                    $icon = "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/" . $ex['id'] . "/" . $imgPath;
                } else {
                    $icon = "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/" . $imgPath;
                }
