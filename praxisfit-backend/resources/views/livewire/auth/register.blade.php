    ...
    <div class="max-w-md w-full space-y-8 bg-white dark:bg-zinc-900 p-8 sm:p-10 rounded-3xl shadow-xl dark:shadow-none border border-zinc-200 dark:border-zinc-800">
        ...
        <div class="text-center">
            <h2 class="text-3xl font-black text-zinc-900 dark:text-zinc-100 tracking-tight">
                Mulai <span class="text-red-600 dark:text-lime-400">Berlatih</span>
            </h2>
            <p class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
                Buat akun PraxisFit Anda hari ini.
            </p>
        </div>

        <form wire:submit="register" class="space-y-5 mt-8">
            <div>
                <label for="name" class="block text-sm font-semibold text-zinc-700 dark:text-zinc-300">Nama Lengkap</label>
                <div class="mt-1">
                    <input wire:model="name" id="name" type="text" required class="appearance-none block w-full px-4 py-3 border border-zinc-300 dark:border-zinc-700 rounded-xl bg-slate-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-red-600 dark:focus:ring-lime-400 focus:border-transparent transition-colors sm:text-sm">
                </div>
                @error('name') <span class="text-red-500 dark:text-red-400 text-xs font-medium mt-1">{{ $message }}</span> @enderror
            </div>

            <div>
                <label for="email" class="block text-sm font-semibold text-zinc-700 dark:text-zinc-300">Alamat Email</label>
                <div class="mt-1">
                    <input wire:model="email" id="email" type="email" required class="appearance-none block w-full px-4 py-3 border border-zinc-300 dark:border-zinc-700 rounded-xl bg-slate-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-red-600 dark:focus:ring-lime-400 focus:border-transparent transition-colors sm:text-sm">
                </div>
            ...
            <div>
                <label for="password_confirmation" class="block text-sm font-semibold text-zinc-700 dark:text-zinc-300">Konfirmasi Sandi</label>
                <div class="mt-1">
                    <input wire:model="password_confirmation" id="password_confirmation" type="password" required class="appearance-none block w-full px-4 py-3 border border-zinc-300 dark:border-zinc-700 rounded-xl bg-slate-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-red-600 dark:focus:ring-lime-400 focus:border-transparent transition-colors sm:text-sm">
                </div>
            </div>
        ...
        <div class="mt-6">
            <div class="relative">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-3 bg-white dark:bg-zinc-900 text-zinc-500 dark:text-zinc-400 font-medium">Atau daftar dengan</span>
                </div>
            </div>
        ...
        <p class="text-center text-sm text-zinc-600 dark:text-zinc-400">
            Sudah punya akun? 
            <a href="{{ route('login') }}" class="font-bold text-red-600 hover:text-red-700 dark:text-lime-400 dark:hover:text-lime-500 transition-colors">
                Masuk di sini
            </a>
        </p>
