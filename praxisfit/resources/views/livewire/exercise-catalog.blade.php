<div class="space-y-8 sm:space-y-12">
    ...
    <!-- HEADER CATALOG -->
    <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-zinc-900 to-zinc-800 dark:from-zinc-900 dark:to-black p-8 sm:p-12 border border-zinc-800 shadow-2xl">
        <!-- Abstract Background Shapes -->
        <div class="absolute top-0 right-0 -mr-16 -mt-16 w-64 h-64 rounded-full bg-red-600/20 blur-3xl pointer-events-none"></div>
        <div class="absolute bottom-0 left-0 -ml-16 -mb-16 w-48 h-48 rounded-full bg-orange-600/20 blur-3xl pointer-events-none"></div>
        ...
        <div class="relative z-10 space-y-4">
            ...
            <h1 class="text-4xl sm:text-5xl font-black tracking-tight text-white drop-shadow-md">
                Katalog <span class="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-400">Latihan</span>
            </h1>
            <p class="text-base text-zinc-400 leading-relaxed max-w-2xl font-medium">
    ...
    <div class="space-y-6">
        ...
        <div class="max-w-2xl relative group">
            <div class="absolute -inset-1 bg-gradient-to-r from-red-600 to-orange-500 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-500"></div>
            <div class="relative">
    ...
    <div wire:loading.class="opacity-50 scale-[0.98]" wire:target="search, filterMuscle" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 transition-all duration-500 ease-out">
        @forelse($exercises as $exercise)
            <div wire:click="openExerciseDetail({{ $exercise->id }})"
                 ...
                 class="group relative bg-white dark:bg-zinc-900 rounded-3xl overflow-hidden border border-zinc-200/80 dark:border-zinc-800/80 hover:border-red-500/50 dark:hover:border-red-500/50 hover:shadow-2xl hover:shadow-red-500/10 transition-all duration-500 hover:-translate-y-2 cursor-pointer flex flex-col">
                
                <!-- Media -->
                <div class="relative overflow-hidden bg-zinc-100 dark:bg-zinc-950 h-56 w-full flex items-center justify-center p-4">
                    <!-- Subtle background glow on hover -->
                    <div class="absolute inset-0 bg-gradient-to-br from-red-500/0 to-orange-500/0 group-hover:from-red-500/10 group-hover:to-orange-500/10 transition-colors duration-500"></div>
                ...
                <div class="p-6 flex-1 flex flex-col justify-between space-y-4 bg-white dark:bg-zinc-900 border-t border-zinc-100 dark:border-zinc-800/50 relative z-10">
                    <div>
                        ...
                        <h3 class="text-lg font-bold text-zinc-900 dark:text-white group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors">
                            {{ $exercise->name }}
                        </h3>
                    </div>
    ...
    <section class="mt-12 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 sm:p-10 shadow-sm relative overflow-hidden">
        ...
        <h3 class="text-3xl font-black text-zinc-900 dark:text-white mb-8 flex items-center gap-3 relative z-10">
            <span class="text-red-600 dark:text-red-500">💡</span> Fakta Medis Latihan
        </h3>
        <div class="space-y-4 relative z-10" x-data="{ activeAccordion: '' }">
            <div class="group bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/80 dark:border-zinc-800 rounded-2xl overflow-hidden transition-all duration-300 hover:border-red-500/30 hover:shadow-md">
                <button @click="activeAccordion = activeAccordion === 'faq1' ? '' : 'faq1'" class="w-full flex justify-between items-center p-6 text-left font-bold text-zinc-900 dark:text-white focus:outline-none">
                    ...
                    <span class="w-8 h-8 rounded-full bg-white dark:bg-zinc-800 flex items-center justify-center text-red-600 dark:text-red-500 transform transition-transform duration-500 shadow-sm border border-zinc-100 dark:border-zinc-700" :class="{'rotate-180': activeAccordion === 'faq1'}">
            ...
            <div class="group bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/80 dark:border-zinc-800 rounded-2xl overflow-hidden transition-all duration-300 hover:border-red-500/30 hover:shadow-md">
                <button @click="activeAccordion = activeAccordion === 'faq2' ? '' : 'faq2'" class="w-full flex justify-between items-center p-6 text-left font-bold text-zinc-900 dark:text-white focus:outline-none">
                    ...
                    <span class="w-8 h-8 rounded-full bg-white dark:bg-zinc-800 flex items-center justify-center text-red-600 dark:text-red-500 transform transition-transform duration-500 shadow-sm border border-zinc-100 dark:border-zinc-700" :class="{'rotate-180': activeAccordion === 'faq2'}">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7"/></svg>
                    </span>
                </button>
        ...
        <template x-teleport="body">
            <div x-data="{ 
                ...
                <div x-show="open" 
                     ...
                     class="absolute inset-0 bg-zinc-900/70 dark:bg-black/80 backdrop-blur-md"></div>
                ...
                <div x-show="open"
                    ...
                    <button @click="open = false" class="absolute top-4 right-4 sm:top-5 sm:right-5 z-50 bg-black/20 hover:bg-black/50 backdrop-blur-md text-white p-2.5 rounded-full transition-all hover:scale-110 active:scale-95">
                        ...
                        <div class="p-6 sm:p-10 -mt-6 relative z-20 space-y-8 bg-white dark:bg-zinc-900 rounded-t-3xl">
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center gap-3">
                                    <span class="px-3 py-1 rounded-lg bg-red-100 dark:bg-red-500/20 text-red-700 dark:text-red-400 font-bold text-xs uppercase tracking-widest">{{ $selectedExercise->target_muscle }}</span>
                                        ...
                                        $instructionsList = collect(preg_split('/[\n\.]+/', $selectedExercise->instructions))
                                            ...
                                            ->map(function($item) use ($terms) {
                                                ...
                                                foreach($terms as $term => $def) {
                                                    ...
                                                    $replacement = '<span @click.stop="activeTerm = \'$1\'; activeDef = \'' . addslashes($def) . '\'; termModalOpen = true;" class="cursor-pointer border-b-2 border-dashed border-red-400 text-red-600 dark:text-red-400 font-bold hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors" title="Klik untuk penjelasan medis">$1</span>';
            ...
            <div x-show="termModalOpen"
                 ...
                 class="absolute inset-0 z-[10000] flex items-center justify-center p-4 bg-zinc-900/60 dark:bg-black/60 backdrop-blur-md"
                ...
                <div @click.stop
                    ...
                    <div class="flex items-center gap-3 mb-4 relative z-10">
                        <span class="text-white bg-gradient-to-br from-red-500 to-orange-500 p-2 rounded-xl shadow-lg shadow-red-500/30">
