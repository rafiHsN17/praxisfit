<div class="space-y-12">
    ...
    <div class="bg-white dark:bg-zinc-900 p-6 sm:p-14 rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-xl dark:shadow-2xl relative overflow-hidden group transition-all duration-500 hover:shadow-2xl">
        ...
        <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-red-500 via-orange-500 to-red-600 dark:from-lime-400 dark:via-emerald-400 dark:to-lime-500"></div>

        <div class="relative z-10 max-w-3xl space-y-6">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-50 dark:bg-lime-400/10 text-red-700 dark:text-lime-400 text-[10px] sm:text-xs font-bold uppercase tracking-wider border border-red-200 dark:border-lime-400/20 shadow-sm">
                <span class="w-2 h-2 rounded-full bg-red-600 dark:bg-lime-400 animate-pulse"></span>
            ...
            <h1 class="text-4xl sm:text-6xl font-black tracking-tight text-zinc-900 dark:text-zinc-100 leading-tight transition-colors">
                Siap Menghancurkan <br class="hidden sm:block"><span class="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-orange-500 dark:from-lime-400 dark:to-emerald-400">Batasmu Hari Ini?</span>
            </h1>
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 pt-4">
                <a href="{{ url('/rutinku') }}" wire:navigate 
                   class="px-6 py-4 rounded-2xl bg-red-600 text-white hover:bg-red-700 dark:bg-lime-400 dark:text-zinc-950 dark:hover:bg-lime-500 font-extrabold text-sm uppercase tracking-wider shadow-lg hover:shadow-red-500/30 dark:hover:shadow-lime-400/30 transition-all duration-300 transform hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <!-- CARD 1: Nutrisi -->
        <a href="{{ url('/kalkulator') }}" wire:navigate 
           class="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl rounded-3xl p-8 border border-zinc-200/80 dark:border-zinc-800/80 shadow-lg hover:-translate-y-2 hover:shadow-2xl hover:border-red-500/50 dark:hover:border-lime-400/50 transition-all duration-500 flex flex-col justify-between group relative overflow-hidden">
            
            <div class="absolute top-0 right-0 w-32 h-32 bg-red-500/5 dark:bg-lime-400/5 rounded-full blur-3xl -translate-y-10 translate-x-10 group-hover:bg-red-500/10 dark:group-hover:bg-lime-400/10 transition-colors duration-500"></div>

            <div class="space-y-5 relative z-10">
                <div class="flex justify-between items-start">
                    <span class="w-12 h-12 rounded-2xl bg-gradient-to-br from-red-100 to-red-50 dark:from-lime-400/20 dark:to-lime-400/5 text-red-600 dark:text-lime-400 flex items-center justify-center border border-red-200 dark:border-lime-400/20 group-hover:scale-110 group-hover:rotate-6 transition-transform duration-500 shadow-sm">
                ...
                <div>
                    ...
                    <div class="flex items-baseline gap-2">
                        <h3 class="text-5xl font-black tracking-tight text-zinc-900 dark:text-zinc-100 group-hover:text-red-600 dark:group-hover:text-lime-400 transition-colors">
                ...
                <div class="space-y-2 pt-2">
                    ...
                    <div class="w-full bg-zinc-100 dark:bg-zinc-950 h-3 rounded-full overflow-hidden p-0.5 border border-zinc-200 dark:border-zinc-800 shadow-inner">
                        <div class="h-full bg-gradient-to-r from-red-500 to-red-600 dark:from-lime-500 dark:to-lime-400 rounded-full transition-all duration-1000 ease-out relative overflow-hidden" 
                    ...
                    <div class="flex justify-between items-center text-xs font-bold">
                        ...
                        <span class="text-red-600 dark:text-lime-400">{{ $percentage }}%</span>
                    </div>
                </div>
            </div>
        </a>
        ...
        <a href="{{ url('/rutinku') }}" wire:navigate 
           class="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl rounded-3xl p-8 border border-zinc-200/80 dark:border-zinc-800/80 shadow-lg hover:-translate-y-2 hover:shadow-2xl hover:border-blue-500/50 dark:hover:border-blue-400/50 transition-all duration-500 flex flex-col justify-between group relative overflow-hidden">
            
            <div class="absolute top-0 right-0 w-32 h-32 bg-blue-500/5 dark:bg-blue-400/5 rounded-full blur-3xl -translate-y-10 translate-x-10 group-hover:bg-blue-500/10 dark:group-hover:bg-blue-400/10 transition-colors duration-500"></div>

            <div class="space-y-5 relative z-10">
                <div class="flex justify-between items-start">
                    <span class="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-100 to-blue-50 dark:from-blue-400/20 dark:to-blue-400/5 text-blue-600 dark:text-blue-400 flex items-center justify-center border border-blue-200 dark:border-blue-400/20 group-hover:scale-110 group-hover:-rotate-6 transition-transform duration-500 shadow-sm">
                ...
                <div>
                    ...
                    <div class="flex items-baseline gap-2">
                        <h3 class="text-5xl font-black tracking-tight text-zinc-900 dark:text-zinc-100 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                            {{ $totalRoutines ?? 0 }}
                        </h3>
            ...
            <div class="mt-8 pt-4 border-t border-zinc-200 dark:border-zinc-800 flex items-center justify-between text-sm font-bold text-blue-600 dark:text-blue-400 group-hover:translate-x-1 transition-transform">
        ...
        <a href="{{ url('/katalog') }}" wire:navigate 
           class="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl rounded-3xl p-8 border border-zinc-200/80 dark:border-zinc-800/80 shadow-lg hover:-translate-y-2 hover:shadow-2xl hover:border-purple-500/50 dark:hover:border-purple-400/50 transition-all duration-500 flex flex-col justify-between group relative overflow-hidden">
            
            <div class="absolute top-0 right-0 w-32 h-32 bg-purple-500/5 dark:bg-purple-400/5 rounded-full blur-3xl -translate-y-10 translate-x-10 group-hover:bg-purple-500/10 dark:group-hover:bg-purple-400/10 transition-colors duration-500"></div>

            <div class="space-y-5 relative z-10">
                <div class="flex justify-between items-start">
                    <span class="w-12 h-12 rounded-2xl bg-gradient-to-br from-purple-100 to-purple-50 dark:from-purple-400/20 dark:to-purple-400/5 text-purple-600 dark:text-purple-400 flex items-center justify-center border border-purple-200 dark:border-purple-400/20 group-hover:scale-110 group-hover:rotate-6 transition-transform duration-500 shadow-sm">
                        <span class="text-2xl">📚</span>
                    </span>
                    <span class="px-3 py-1 rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-300 font-extrabold text-[10px] uppercase tracking-wider border border-zinc-200 dark:border-zinc-700">
                        Database
                ...
                <div>
                    ...
                    <div class="flex items-baseline gap-2">
                        <h3 class="text-5xl font-black tracking-tight text-zinc-900 dark:text-zinc-100 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
                            {{ $totalExercises ?: 310 }}<span class="text-3xl text-purple-600 dark:text-purple-400">+</span>
                        </h3>
                    </div>
                </div>
            ...
            <div class="mt-8 pt-4 border-t border-zinc-200 dark:border-zinc-800 flex items-center justify-between text-sm font-bold text-purple-600 dark:text-purple-400 group-hover:translate-x-1 transition-transform">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
        <!-- Inspiration Card -->
        <div class="lg:col-span-1 bg-gradient-to-br from-zinc-900 to-zinc-800 dark:from-zinc-800 dark:to-zinc-950 p-8 rounded-3xl shadow-2xl relative overflow-hidden flex flex-col justify-between border border-zinc-700">
            ...
            <div class="space-y-4 relative z-10">
                <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 text-white text-[10px] font-bold uppercase tracking-wider backdrop-blur-md border border-white/20">
                    <span>Strategi & Tips Pro</span>
                </div>
                <h3 class="text-2xl sm:text-3xl font-black tracking-tight text-white leading-tight">
                    Progressif Overload Adalah Kunci.
                </h3>
            </div>
            
            <div class="relative z-10 mt-8">
                <p class="text-sm font-medium text-zinc-300 leading-relaxed italic">
                ...
                <div class="mt-6 pt-6 border-t border-white/10 flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-white font-bold text-sm">Dr. Brad Schoenfeld, Ph.D.</p>
                        <p class="text-zinc-400 text-xs">J. Strength & Conditioning Research</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="lg:col-span-2 bg-white dark:bg-zinc-900 p-8 rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-xl">
            <h3 class="text-2xl font-extrabold text-zinc-900 dark:text-zinc-100 mb-6 flex items-center gap-3">
                <span class="bg-red-100 dark:bg-lime-400/20 text-red-600 dark:text-lime-400 p-2 rounded-xl">💡</span>
            ...
            <div class="space-y-4" x-data="{ activeAccordion: 'faq1' }">
                ...
                <div class="border border-zinc-200 dark:border-zinc-700/50 rounded-2xl overflow-hidden transition-all duration-300">
                    <button @click="activeAccordion = activeAccordion === 'faq1' ? '' : 'faq1'" class="w-full flex justify-between items-center p-5 text-left font-bold text-zinc-800 dark:text-zinc-200 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors focus:outline-none">
                        ...
                        <svg class="w-5 h-5 text-red-600 dark:text-lime-400 transform transition-transform duration-300" :class="{'rotate-180': activeAccordion === 'faq1'}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                    </button>
                ...
                <div class="border border-zinc-200 dark:border-zinc-700/50 rounded-2xl overflow-hidden transition-all duration-300">
                    <button @click="activeAccordion = activeAccordion === 'faq2' ? '' : 'faq2'" class="w-full flex justify-between items-center p-5 text-left font-bold text-zinc-800 dark:text-zinc-200 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors focus:outline-none">
                        ...
                        <svg class="w-5 h-5 text-red-600 dark:text-lime-400 transform transition-transform duration-300" :class="{'rotate-180': activeAccordion === 'faq2'}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                    </button>
            ...
            <div class="mt-6 text-center">
                <a href="{{ url('/faq') }}" wire:navigate class="inline-flex items-center gap-2 text-sm font-bold text-red-600 dark:text-lime-400 hover:text-red-700 dark:hover:text-lime-300 transition-colors hover:underline">
